...
################################################################
# This is a generated script based on design: stream_acc_design
#
...
# source stream_acc_design_script.tcl
...
set design_name stream_acc_design
...
proc create_root_design { parentCell } {
  ...
  # Create instance: polynomial_stream_acc_0, and set properties
  set polynomial_stream_acc_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:polynomial_stream_acc:1.0 polynomial_stream_acc_0 ]
  ...
  connect_bd_intf_net -intf_net axi_fifo_mm_s_0_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD] [get_bd_intf_pins polynomial_stream_acc_0/S00_AXIS]
  connect_bd_intf_net -intf_net polynomial_stream_acc_0_M00_AXIS [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD] [get_bd_intf_pins polynomial_stream_acc_0/M00_AXIS]
  ...
  connect_bd_net -net Net [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins polynomial_stream_acc_0/m00_axis_aclk] [get_bd_pins polynomial_stream_acc_0/s00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net axi_fifo_mm_s_0_mm2s_prmry_reset_out_n [get_bd_pins axi_fifo_mm_s_0/mm2s_prmry_reset_out_n] [get_bd_pins polynomial_stream_acc_0/m00_axis_aresetn]
  connect_bd_net -net axi_fifo_mm_s_0_s2mm_prmry_reset_out_n [get_bd_pins axi_fifo_mm_s_0/s2mm_prmry_reset_out_n] [get_bd_pins polynomial_stream_acc_0/s00_axis_aresetn]
